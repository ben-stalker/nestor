...
- [ ] Permission: any profile can manage own journeys; admin can manage all
...
- [ ] Unit: stub returns mins
- [ ] Unit: CRUD round-trip
- [ ] Unit: days_active filter
- [ ] Unit: ETA endpoint dispatches
- [ ] RTL: widget renders rows
- [ ] RTL: empty state when no journeys
- [ ] RTL: refresh interval 5min
