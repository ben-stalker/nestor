...
import { verifyPin } from '../api/profiles';
...
export default function PinPrompt({ profile, onSuccess, onClose }: PinPromptProps) {
  ...
  const submitPin = useCallback(
    ...
    [profile.id, onSuccess, submitting, triggerShake],
  );
  ...
  return (
    <Modal open onClose={onClose} title={`Enter PIN for ${profile.name}`}>
